<template>
  <div>
    <div style="margin-bottom: 10px;text-align: center">
      <el-input v-model="name" placeholder="Please enter classification name" suffix-icon="el-icon-search" style="width:200px"
    ...
    >
      ...
      <el-table-column prop="name" label="Classification Name" width="280">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    loadPost() {
      this.$axios.post(this.$httpUrl+'/goodstype/listPageEn',{
